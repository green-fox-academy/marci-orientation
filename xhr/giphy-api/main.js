...
var GIPHY = /** @class */ (function () {
    function GIPHY(API_URL, API_KEY, myRequest, myGIF, asd) {
        ...
        if (asd === void 0) { asd = document.createElement("img"); }
    ...
    GIPHY.prototype.open = function () {
        this.myRequest.open("GET", this.API_URL + "?api_key=" + this.API_KEY + "&q=random&limit=16");
    };
